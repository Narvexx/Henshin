...
public class Solution {
	...
	public Map<String, Integer> featureConfiguration;
	...
	public Solution(List<Variable> variables,
			...
			ConditionHandler conditionHandler, Map<String, Integer> featureConfig) {
		...
		this.featureConfiguration = featureConfig;
		
	}

	public Map<String, Integer> getFeatureConfiguration() {
