...
public interface Engine {
	...
	Iterable<Match> findMatches(Rule rule, EGraph graph, Match partialMatch, List<Map<String, Integer>> seenConfigurations);
	
	Match getBaseMatch(Rule rule, EGraph graph);
